...
function getname($sql, $fields,$con){
...
$produk = $_POST['produk'];
// Filter Tanggal
$tanggal_awal = $_POST['tgl_mulai']; // Tanggal Awal yang dipilih oleh pengguna
$tanggal_akhir = $_POST['tgl_akhir']; // Tanggal Akhir yang dipilih oleh pengguna
$tanggal_awal_format = date("d-m-Y", strtotime($tanggal_awal));
$tanggal_akhir_format = date("d-m-Y", strtotime($tanggal_akhir));
?>
...
.button-container {
    display: flex;
    justify-content: flex-end; /* Mengatur elemen ke kanan */
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							<div class="dashboard_bar">
                              History Tanggal <?php echo $tanggal_awal_format;?> s.d. <?php echo $tanggal_akhir_format;?>
                            </div>
                        </div>
                    </div>
				</nav>
					...
					<div class="col-12">
                        <div class="card">
							...
							<div class="button-container">
								<a href="excel_history.php?tgl_mulai=<?php echo $tanggal_awal;?>&tgl_terakhir=<?php echo $tanggal_akhir;?>&produk=<?php echo $produk;?>" target="_blank" type="button" class="btn btn-warning">Export Excel</a>
							</div>
							<!-- Modal -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    WHERE 
                                        ...
                                        AND (produk.nama_produk LIKE '%$produk%' OR produk.kode_produk LIKE '%$produk%') 
                                    ORDER BY 
                                        history.tanggal DESC");	
										while($rw = mysql_fetch_array($sql)){ ?>
                                            <tr>
                                                <td><?php echo $n; ?></td>
												<td><?php if ($rw['status'] == 'IN') {
												...
												<td><?php $karyawan = getname("select MASNAM from master where MASNIP = $rw[karyawan] ","MASNAM",$koneksi2); if($karyawan == ''){echo $rw['karyawan']; }else{ echo $karyawan;}?></td>
                                                <td><?php echo $rw['jumlah_sebelum']; ?></td>		
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="./vendor/global/global.min.js"></scrip>
