                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="edit/password.php" method="post" class="form-valide-with-icon needs-validation" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label class="text-label form-label" for="validationCustomUsername">Username</label>
                                            <div class="input-group">
												<span class="input-group-text"> <i class="fa fa-user"></i> </span>
												<input type="hidden" class="form-control" name="id" id="validationCustomUsername" value="<?php echo $_SESSION['id']; ?>">
                                                <input type="hidden" class="form-control" name="password" id="validationCustomUsername" value="<?php echo $_SESSION['password']; ?>">
                                                <input type="text" class="form-control" name="username" id="validationCustomUsername" value="<?php echo $_SESSION['username']; ?>">
												<div class="invalid-feedback">
												</div>
                                            </div>
                                        </div>
										<div class="mb-3">
                                            <label class="text-label form-label" for="validationCustomUsername">Nama</label>
                                            <div class="input-group">
												<span class="input-group-text"> <i class="fa fa-user-circle-o"></i> </span>
                                                <input type="text" class="form-control" name="nama" id="validationCustomUsername" value="<?php echo $_SESSION['nama']; ?>">
												<div class="invalid-feedback">
												  </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group transparent-append">
                                                ...
                                                <input type="password" class="form-control" id="dlab-password" name="oldpass" placeholder="Choose a safe one.." required>
										...
										<div class="mb-3">
                                            ...
                                            <div class="input-group transparent-append">
                                                ...
                                                <input type="password" class="form-control" id="dlab-password" name="newpass" placeholder="Choose a safe one.." required>
												<span class="input-group-text show-pass"> 
													<i class="fa fa-eye-slash"></i>
													<i class="fa fa-eye"></i>
												</span>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="file" class="form-control" name="foto[]" id="validationCustomUsername">
												<div class="invalid-feedback">
												  </div>
                                            </div>
                                        </div>
