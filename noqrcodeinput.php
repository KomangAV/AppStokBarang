            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Stok Masuk </a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="proses/in.php" method="post" class="form-valide-with-icon needs-validation" enctype="multipart/form-data">
                                        <div class="mb-3">
										<div class="form-group">
											<h6 for="produk">Produk *</h6>
											<select class="form-control" id="produk3" name="produk" oninput="isiDeskripsi3(); isiFoto();" required>
												<option value="-" disabled selected>Pilih Salah Satu</option>
												<?php
												$sql1 = mysql_query("SELECT kode_produk, nama_produk FROM produk order by nama_produk");
												while ($s = mysql_fetch_array($sql1)) { ?>
													<option value="<?php echo $s['kode_produk']; ?>"><?php echo $s['nama_produk']; ?> (<?php echo $s['kode_produk']; ?>)</option>
												<?php } ?>
											</select>
										</div>
                                        </div>
										<div class="mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="deskripsi3" name="deskripsi" readonly></textarea>
                                            </div>
                                        </div>
                                            <div class="mb-3">
                                                <div class="form-group">
                                                    <h6 for="stok">Jumlah Stok Masuk *</h6>
											...
											<div class="mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <img width="150" height="150" id="productImage" src="images/kosong.png" onclick="openPopup()" alt="Foto Produk">
                                                </div>
                                            </div>
                                        </div>
...
<script>
function isiFoto() {
    const inputField = document.getElementById('produk3');
