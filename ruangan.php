					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List Ruangan/Gudang</h4>
                            </div>
                            <div class="button-container">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Modal">
								Tambah Ruangan/Gudang
							</button>
                            <a href="#" data-toggle="modal" data-target="#printModalall" type="button" class="btn btn-warning">Print Semua Ruangan</a>
							</div>

                            <!-- Print Modal -->
                            <div class="modal fade" id="printModalall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="exampleModalLabel">Print Kode Semua Ruangan </h4>
                                        
                                        </div>
                                        <div class="modal-body">
                                        <form action="printkoderuanganall.php" target="_blank" method="post">
                                            <div class="form-group">
                                                <h6 for="ruangan">Jumlah Print Kode Semua Ruangan </h6>
							...
							<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Input Ruangan/Gudang</h4>
										
										</div>
										<div class="modal-body">
										<form action="proses/ruangan.php" method="post">
											<div class="form-group">
                                            <h6 for="produk">Kode Ruangan </h6>
                                            <?php
												$data2 = mysql_query("select MAX(kodemax) as max from ruangan");
												$d2 = mysql_fetch_array($data2);
												$max_kode2 = $d2['max'];
                                                echo $max_kode2;
												if (!is_null($max_kode2)) {
													// Mengambil angka dari kode maksimum, menambahkannya, dan memformatnya sebagai kode baru
													$angka_terakhir2 = $max_kode2 + 1;
													$kode_baru2 = 'R' . str_pad($angka_terakhir2, 5, '0', STR_PAD_LEFT); // 3 digit, misalnya "001", "002", dst.
												} else {
													// Jika tidak ada data di database, kode pertama akan menjadi "BR001"
													$kode_baru2 = 'R00001';
												}
                                            ?>
                                            	<input type="text" class="form-control" id="kode_ruangan" name="kode_ruangan" value="<?php echo $kode_baru2;?>" readonly>
											</div>
                                            <div class="form-group">
												<h6 for="ruangan">Nama Ruangan/Gudang </h6>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
										...
										include 'config/koneksi.php';
										$n=1;
										$sql = mysql_query("select * from ruangan order by id DESC");	
										while($rw = mysql_fetch_array($sql)){ ?>
                                            <tr>
                                                <td><?php echo $n; ?></td>
                                                <td><?php echo $rw['kode_ruangan']; ?></td>
                                                <td><?php echo $rw['ruangan']; ?></td>
                                                <td>
													<div class="d-flex">
                                                        <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" data-toggle="modal" data-target="#printModal<?php echo $rw['kode_ruangan'];?>" title="Print Kode Ruangan" ><i class="fa fa-print"></i></a>
											...
											<div class="modal fade" id="editModal<?php echo $rw['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														<div class="modal-header">
															<h4 class="modal-title" id="exampleModalLabel">Edit Ruangan/Gudang</h4>
														
														</div>
														<div class="modal-body">
														<form action="edit/ruangan.php?id=<?php echo $rw['id'];?>" method="post">
															<div class="form-group">
																<h6 for="ruangan">Nama Ruangan </h6>
																<input type="text" class="form-control" id="ruangan" name="ruangan" value="<?php echo $rw['ruangan'];?>">
															</div>
															<br>
															<button type="submit" class="btn btn-primary">Simpan</button>
															<button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="delete/ruangan.php?id=<?php echo $rw['id'];?>" class="btn btn-danger" id="hapusButton">Hapus</a>
														</div>
													</div>
												</div>
											</div>
                                            <!-- Print Modal -->
											<div class="modal fade" id="printModal<?php echo $rw['kode_ruangan'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														<div class="modal-header">
															<h4 class="modal-title" id="exampleModalLabel">Print Kode Ruangan  </h4>
														
														</div>
														<div class="modal-body">
														<form action="printkoderuangan.php?id=<?php echo $rw['kode_ruangan'];?>" target="_blank" method="post">
															<div class="form-group">
																<h6 for="ruangan">Jumlah Print Kode Ruangan</h6>
																<input type="number" class="form-control" id="jumlah" name="jumlah">
															</div>
															<br>
															<button type="submit" class="btn btn-primary">Simpan</button>
