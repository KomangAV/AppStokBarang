        ...
        ***********************************-->
        <div class="content-body">
			...
			<?php if ($_SESSION['role'] == '0' || $_SESSION['role'] == '1'){ ?>
						...
						<a href="qrcodeinput.php">
							<div class="card bg-primary invoice-card">
								<div class="card-body d-flex">
									...
									<div>
										<h2 class="text-white invoice-num">Stok Masuk QR-Code</h2>
									</div>
								</div>
							</div>
						</a>
						...
						<a href="noqrcodeinput.php">
							<div class="card bg-primary invoice-card">
								<div class="card-body d-flex">
									...
									<div>
										<h2 class="text-white invoice-num">Stok Masuk </h2>
									</div>
								</div>
							</div>
						</a>
						...
						<a href="stokkeluar.php">
							<div class="card bg-success invoice-card">
								<div class="card-body d-flex">
									...
									<div>
										<h2 class="text-white voice-card">Stok Keluar</h2>
									</div>
								</div>
							</div>
						</a>
					...
					<?php if ($_SESSION['role'] == '0' || $_SESSION['role'] == '1'){ ?>
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<a href="#" data-toggle="modal" data-target="#dateModal">
							<div class="card bg-primary invoice-card">
								<div class="card-body d-flex">
									<div class="icon me-3">
									...
									<div>
										<h2 class="text-white invoice-num">History</h2>
									</div>
								</div>
							</div>
						</a>
				...
				<?php } ?>
					...
					<!-- InModal -->
					<div class="modal fade" id="InModalBarcode" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Stok Masuk</h4>
										
										</div>
										<div class="modal-body">
										<form action="proses/in.php" method="post">
										<div class="form-group">
											<h6 for="search_produk">Kode Produk</h6>
										
											<input class="form-control" type="text" class="produk" id="produk"  onmouseover="focus();" oninput="isiDeskripsi()" required>
										</div>
					...
					<div class="modal fade" id="InModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<form action="proses/in.php" method="post">
										<!-- <div class="form-group">
											<h6 for="search_produk">Filter Produk</h6>
											<input type="text" class="form-control" id="searchInput" placeholder="Filter Produk">
										</div> -->
										<div class="form-group">
											<h6 for="produk">Produk *</h6>
											<select class="form-control" id="produk3" name="produk" oninput="isiDeskripsi3()" required>
				...
				<div class="modal fade" id="OutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Stok Keluar</h4>
										
										</div>
										<div class="modal-body">
										<form action="proses/out.php" method="post">
										<div class="form-group">
											<h6 for="search_produk">Masukan Kode/Nama Produk</h6>
											<input type="text" class="form-control" id="searchInput2" placeholder="Filter Produk" oninput="filterProduk();">
										</div>
										<div class="form-group">
											<h6 for="produk">Produk *</h6>
											<select class="form-control" id="produk2" name="produk" onmouseover="isiDeskripsi2()" required>
										...
										<!-- <div class="form-group">
											<h6 for="search_produk">Filter Karyawan</h6>
											<input type="text" class="form-control" id="searchKaryawan" placeholder="Filter Karyawan">
										</div> -->
				...
				<div class="modal fade" id="dateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">History Stok</h4>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<h6 for="produk">Kode/Nama Produk</h6>
													<input type="text" class="form-control" id="produk" placeholder="Masukkan Kode/Nama Produk" name="produk">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<h6 for="tgl_mulai">Tanggal Awal</h6>
													<input type="date" class="form-control" id="tgl_mulai" name="tgl_mulai" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<h6 for="tgl_akhir">Tanggal Akhir</h6>
						...
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									?>
									<h2 class="text-white invoice-num"><?php echo $jumlah; ?></h2>
									<span class="text-white fs-18">Total Produk</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									$jumlah = mysql_num_rows($result);
									?>
									<h2 class="text-white voice-card"><?php echo $jumlah; ?></h2>
									<span class="text-white fs-18">Total Kategori</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									?>
									<h2 class="text-white invoice-num"><?php echo $jumlah; ?></h2>
									<span class="text-white fs-18">Total Ruangan</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									?>
									<h2 class="text-white invoice-num"><?php echo $jumlah; ?></h2>
									<span class="text-white fs-18">Total Supplier</span>
								</div>
							</div>
						</div>
					</div>
