								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Input Supplier</h4>
										
										</div>
										<div class="modal-body">
										<form action="proses/supplier.php" method="post">
											<div class="form-group">
												<h6 for="supplier">Nama Supplier </h6>
												<input type="text" class="form-control" id="supplier" name="supplier" placeholder="Masukkan nama Supplier">
											</div>
                                            <div class="form-group">
												<h6 for="alamat">Alamat</h6>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
										...
										$n=1;
										$sql = mysql_query("select * from supplier order by id DESC");	
											...
											<div class="modal fade" id="editModal<?php echo $rw['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
														<form action="edit/supplier.php?id=<?php echo $rw['id'];?>" method="post">
															<div class="form-group">
																<h6 for="supplier">Nama Kategori </h6>
																<input type="text" class="form-control" id="supplier" name="supplier" value="<?php echo $rw['supplier'];?>">
															</div>
                                                            <div class="form-group">
                                                                <h6 for="alamat">Alamat</h6>
                                                                <textarea class="form-control" id="alamat" name="alamat" ><?php echo $rw['alamat'];?></textarea>
                                                            </div>
															<br>
															<button type="submit" class="btn btn-primary">Simpan</button>
															<button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="delete/supplier.php?id=<?php echo $rw['id'];?>" class="btn btn-danger" id="hapusButton">Hapus</a>
														</div>
													</div>
												</div>
											</div>
