                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Memindahkan Banyak Produk Ke Ruangan Sekaligus</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="edit/multipleruangan.php" method="post" class="form-valide-with-icon needs-validation" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <h6 class="text-label form-label" for="validationCustomproduk">Produk</h6>
                                            <?php
                                            $query = "SELECT kode_produk, nama_produk FROM produk order by nama_produk";
                                            $result = mysql_query($query);
                                            while ($s=mysql_fetch_array($result)) { ?>
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" name="kode_produk[]"  value="<?php echo $s['kode_produk'];?>">
                                                <label class="form-check-label" ><?php echo $s['nama_produk'];?></label>
                                            </div>
                                            <?php } ?>
                                        </div>
										<div class="mb-3">
                                            <div class="form-group">
												...
												<?php
												$sql=mysql_query("SELECT ruangan FROM ruangan ");
