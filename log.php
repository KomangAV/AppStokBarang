					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Log System </h4>
                            </div>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Log System</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
										...
										$n=1;
										$sql = mysql_query("SELECT * FROM log order by id DESC");	
										while($rw = mysql_fetch_array($sql)){ ?>
                                            <tr>
                                                <td><?php echo $n; ?></td>
												<td><?php if ($rw['action'] == 'Input') {
													echo '<span style="color: blue;">' . $rw['action'] . '</span>';
												} elseif ($rw['action'] == 'Delete') {
													echo '<span style="color: red;">' . $rw['action'] . '</span>';
												} else {
													echo '<span style="color: green;">' . $rw['action'] . '</span>';
												} ?></td>
												<td><?php echo $rw['nama']; ?></td>
                                                <td><?php echo $rw['kategori']; ?></td>
                                                <td><?php echo $rw['namaa']; ?></td>
