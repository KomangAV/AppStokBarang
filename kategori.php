								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Input Kategori</h4>
										
										</div>
										<div class="modal-body">
										<form action="proses/kategori.php" method="post">
											<div class="form-group">
												<h6 for="kategori">Nama Kategori </h6>
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
										...
										while($rw = mysql_fetch_array($sql)){ ?>
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="#" class="btn btn-primary shadow btn-xs sharp me-1" data-toggle="modal" data-target="#editModal<?php echo $rw['id'];?>"><i class="fa fa-pencil" title="Edit"></i></a>
											...
											<div class="modal fade" id="editModal<?php echo $rw['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
														<form action="edit/kategori.php?id=<?php echo $rw['id'];?>" method="post">
															<div class="form-group">
																<h6 for="kategori">Nama Kategori </h6>
																<input type="text" class="form-control" id="kategori" name="kategori" value="<?php echo $rw['kategori'];?>">
															</div>
															<br>
															<button type="submit" class="btn btn-primary">Simpan</button>
															<button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="delete/kategori.php?id=<?php echo $rw['id'];?>" class="btn btn-danger" id="hapusButton">Hapus</a>
														</div>
													</div>
												</div>
											</div>
