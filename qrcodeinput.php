            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Stok Masuk QR-Code</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Stok Masuk QR-Code</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form action="proses/in.php" method="post" class="form-valide-with-icon needs-validation" enctype="multipart/form-data">
										<div class="mb-3">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="searchInput" placeholder="Filter Produk" oninput="filterProduk(); " autofocus required>
											</div>
                                        </div>
										<div class="mb-3">
											<div class="form-group">
												<h6 for="produk">Produk *</h6>
												<select class="form-control" id="produk" name="produk" onmouseover="isiDeskripsi();isiFoto();" required>
...
function filterProduk() {
    var filterText = document.getElementById("searchInput").value.toLowerCase();
...
<script>
function isiFoto() {
    const inputField = document.getElementById('produk');
