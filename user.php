					...
					<div class="col-12">
                        <div class="card">
							...
							<div class="button-container">
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Modal">Tambah User</button>
							</div>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Input User Baru</h4>
										...
										<form action="proses/user.php" method="post">
											...
											<div class="form-group">
												...
												<input type="password" class="form-control" id="password" name="password" placeholder="Masukkan nama password">
											</div>				
											<div class="form-group">
												<h6 for="supplier">Role</h6>
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
										...
										while($rw = mysql_fetch_array($sql)){ ?>
                                            <tr>
												...
												<td><?php if($rw['role']=='1'){echo "Admin";}else if($rw['role']=='2'){echo "User";}else{ echo "Super Admin";} ?></td>
                                                <td>
													<div class="d-flex">
											...
											<div class="modal fade" id="editModal<?php echo $rw['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
														<form action="edit/user.php?id=<?php echo $rw['id'];?>" method="post">
														<div class="form-group">
															<h6 for="nama">Nama User </h6>
															<input type="text" class="form-control" id="nama" name="nama" value="<?php echo $rw['nama'];?>" placeholder="Masukkan nama">
														</div>
														<div class="form-group">
															<h6 for="role">Role</h6>
															<select class="form-control" id="role" name="role">
															<option value="<?php echo $rw['role'];?>"><?php if($rw['role'] == '1'){ echo "Admin";}else{ echo "User"; }?></option>
															<?php if($_SESSION['role'] == 0){ ?>
															<option value="0">Super Admin</option>
															<?php } ?>
															<option value="1">Admin</option>
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="delete/user.php?id=<?php echo $rw['id'];?>" class="btn btn-danger" id="hapusButton">Hapus</a>
														</div>
													</div>
												</div>
											</div>
