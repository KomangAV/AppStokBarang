...
$input=mysql_query("INSERT INTO history VALUES ('', '$kode_produk','$stok_sekarang','$stok','$waktu_indonesia','$karyawan','OUT')");
...
$input2=mysql_query("INSERT INTO log VALUES ('', '$nama','$tanggal_waktu','Stok Keluar','$nama_produk','Input')");
